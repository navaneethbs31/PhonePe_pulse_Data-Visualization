...
#================================================= All India Transaction ==============================================
    with tab1:
        ...
        df_trans_qry_result1_fig.update_layout(title_font=dict(size=33),title_font_color="#6739b7")
        ...
        with col5:
            st.subheader("TransactionAmount")
    ...
    with tab2:
        ...
        df_user_qry_result1_fig.update_layout(title_font=dict(size=33),title_font_color="#6739b7")
...
#==================================================/ State Wise / ==========================================================
    ...
    with tab3:
        ...
        df_st_trans_qry_result1_fig.update_layout(title_font=dict(size=33),title_font_color="#6739b7")
